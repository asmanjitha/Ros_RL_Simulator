...
public class ROSTransformTreePublisherHuman : MonoBehaviour
{
    ...
    [SerializeField]
    List<string> m_GlobalFrameIds = new List<string> { "human/map", "human/odom" };
    [SerializeField]
    ...
    void PublishMessage(uint sequenceNumber)
    {
